    ...
    return Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index){
            return Container(
              width: getDeviceWidth(context) > 580 ? getDeviceWidth(context) * 0.44 : getDeviceWidth(context) * 0.9,
              height: getDeviceWidth(context) > 580 ? getDeviceHeight(context) * 0.15 : getDeviceHeight(context) * 0.1,
              margin: EdgeInsets.only(
                left: getDeviceWidth(context) > 580 ? getDeviceWidth(context) * 0.23 :getDeviceWidth(context) * 0.05,
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.only(
                              top: getDeviceWidth(context) > 580 ?  getDeviceHeight(context) * 0.01 : 0.0,
                              left: getDeviceWidth(context) * 0.05,
                          ...
                          // Number Text
                          Container(
                            width: getDeviceWidth(context) > 580 ? getDeviceWidth(context) * 0.25 :getDeviceWidth(context) * 0.4,
                            height: getDeviceHeight(context) * 0.1,
                            margin: EdgeInsets.only(
                              right: getDeviceWidth(context) > 580 ? 0.0 : getDeviceWidth(context) * 0.02
                            ),
                            child: Column(
                              children: [
                                const Spacer(),
                                Text("${viewModel.numbers[index].numberCountryCode} ${viewModel.numbers[index].numberText}", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: getDeviceWidth(context) > 580 ? getDeviceWidth(context) * 0.02 : getDeviceWidth(context) * 0.05), textAlign: getDeviceWidth(context) > 580 ? TextAlign.left : TextAlign.center,),
                                Text("Sent :${viewModel.numbers[index].numberDate}", style: TextStyle(color: Colors.black, fontSize: getDeviceWidth(context) > 580 ? getDeviceWidth(context) * 0.015 : getDeviceWidth(context) * 0.025, fontWeight: FontWeight.bold), textAlign: TextAlign.left,),
                                const Spacer(),
                              ],
                            )
                          ),
                          ...
                          InkWell(
                            ...
                            height: getDeviceHeight(context) * 0.1,
                            margin: EdgeInsets.only(
                              right: getDeviceWidth(context) > 580 ?  getDeviceWidth(context) * 0.02 : getDeviceWidth(context) * 0.08
                            ),
                            child: Icon(Icons.keyboard_arrow_up, size: getDeviceWidth(context) > 580 ? 45 : 56, color: Colors.black.withOpacity(0.6),),
                           ),
                          ),
                        ],
                      ),
