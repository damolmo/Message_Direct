...
class MessageField extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return Container(
      ...
      height: getDeviceWidth(context) > 580 ? getDeviceHeight(context) * 0.2 : viewModel.isMessageFieldActive ? getDeviceHeight(context) * 0.3 : getDeviceHeight(context) * 0.12,
      margin: EdgeInsets.only(
        ...
        top: getDeviceWidth(context) > 580 ? getDeviceHeight(context) * 0.6 : viewModel.isMessageFieldActive ? getDeviceHeight(context) * 0.3 : getDeviceHeight(context) * 0.7,
        bottom: getDeviceWidth(context) > 580 ? getDeviceHeight(context) * 0.25 : viewModel.isMessageFieldActive ? getDeviceHeight(context) * 0.3 : getDeviceHeight(context) * 0.18
      ),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(color: Colors.black, fontSize: getDeviceWidth(context) > 580 ?  getDeviceWidth(context) * 0.03 :getDeviceWidth(context) * 0.06, fontWeight: FontWeight.bold)
        ),
