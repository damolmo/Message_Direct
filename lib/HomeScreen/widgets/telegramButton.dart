            ...
            child :  Row(
              children: [
                ...
                Container(
                  ...
                  child: Center(child: Text(viewModel.isWhatsAppUrl ? "WhatsApp Mode" : "Telegram Mode", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: getDeviceWidth(context) * 0.05), textAlign: TextAlign.center,)),
                )
              ],
          ),
        ),
